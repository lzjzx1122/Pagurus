...
res = pd.read_csv('result/cold_start.csv')
...
# plt.show()
fig.savefig("result/fig_14_a.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("result/fig_14_b.pdf",bbox_inches='tight')
...
res = pd.read_csv('result/e2e_latency.csv')
...
y2 = res["pagurus/openwhisk"].values
# print(len(y2))
...
# plt.show()
fig.savefig("result/fig_15.pdf",bbox_inches='tight')
