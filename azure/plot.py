...
# plt.show()
fig.savefig("expected_result/fig_14_a.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("expected_result/fig_14_b.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("expected_result/fig_15.pdf",bbox_inches='tight')