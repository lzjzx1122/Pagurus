...
def init(config_file, port_range, db_url, db_name):
    ...
    for info in info_list:
        action = Action(client, db, db_lend, db_container_global, db_zygote, info, pm, prewarm_manager)
...
class Action:
    def __init__(self, client, database, db_lend, db_container, db_zygote, action_info, port_manager, prewarm_manager):
