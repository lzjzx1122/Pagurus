...
# generate Fig.11
data = pd.read_csv('expected_result/remained_cold.csv')
...
random = list(data['random'].values)
...
openwhisk = [1455]
tmpx = np.arange(4)
tmpy = np.array([247, 451, 522, 1455])
...
# plt.show()
fig.savefig("expected_result/fig_11.pdf",bbox_inches='tight')
...
# generate Fig 12
data_prewarm = pd.read_csv('expected_result/startup_time.csv')
...
# plt.show()
fig.savefig("expected_result/fig_12.pdf",bbox_inches='tight')
...
#generate Fig 13a
data = pd.read_csv('expected_result/normalized_latency.csv')
...
# plt.show()
fig.savefig("expected_result/fig_13_a.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("expected_result/fig_13_b.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("expected_result/fig_13_c.pdf",bbox_inches='tight')
...
# plt.show()
fig.savefig("expected_result/fig_13_d.pdf",bbox_inches='tight')
